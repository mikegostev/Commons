...
public class LongTreeMap<V> extends LongAbstractMap<V> implements Cloneable,
...
//   int cmp = key - t.key;
 ...
 private class SubMap extends LongAbstractMap<V> implements LongMap<V>,
   java.io.Serializable
 {
 ...
 private class SubMapEntryIterator extends
   PrivateEntryIterator<LongMap.Entry<V>>
 {
