...
public class ListUnionTest
{
 ...
 public static void main(String[] args)
 {
  ...
  for( int i=0; i < 10; i++ )
  {
   System.out.println(lit.hasNext()+" el="+el+" prev("+lit.previousIndex()+")="+(lit.previousIndex()>=0?union.get(lit.previousIndex()):"?")
     +" next("+lit.nextIndex()+")="+(lit.nextIndex()<union.size()?union.get(lit.nextIndex()):"?"));
...
//  lit = union.listIterator(union.size());
  ...
  for( int i=0; i < 10; i++ )
  {
   System.out.println(lit.hasPrevious()+" el="+el+" prev("+lit.previousIndex()+")="+(lit.previousIndex()>=0?union.get(lit.previousIndex()):"?")
     +" next("+lit.nextIndex()+")="+(lit.nextIndex()<union.size()?union.get(lit.nextIndex()):"?"));
