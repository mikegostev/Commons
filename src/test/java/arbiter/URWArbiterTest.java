...
public class URWArbiterTest
{
 ...
 {
  UpgradableRWArbiter<Request,Request,Request> arb = new UpgradableRWArbiter<Request,Request,Request>(new TokenFactory<Request,Request,Request>()
                                   {
  ...
  synchronized void printStat()
  {
   ...
   System.out.println("Max simultaneous read requests while some upgradable read requests  : " + maxSimRReqsWithUR);
   System.out.println("Max simultaneous read requests while some write requests  : " + maxSimRReqsWithW);
   System.out.println("Max simultaneous read requests while some upgraded write requests  : " + maxSimRReqsWithUW);
