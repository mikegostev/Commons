...
public class PkStrTest
{
 ...
 {
//   Object packed = PackedString.pack("ƢabcdefghijklmnopqrstuvwxyzΏАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯabcdefghijklmnopqrstuvwxyzабвгдеёжзийклмнопрстуфхцчшщъыьэюя");
