...
public abstract class IntAbstractMap<V> implements IntMap<V> {

    /**
     * Sole constructor.  (For invocation by subclass constructors, typically implicit.)
     */
    protected IntAbstractMap() {
    }
     ...
     */
    public void putAll(Map<Integer, ? extends V> t) {
        Iterator<? extends Map.Entry<Integer, ? extends V>> i = t.entrySet().iterator();
        while (i.hasNext()) {
            Map.Entry<Integer, ? extends V> e = i.next();
    ...
    public Set<Integer> keySet() {
        if (keySet == null) {
            keySet = new AbstractSet<Integer>() {
                ...
                public int size() {
                    return IntAbstractMap.this.size();
                }

                @SuppressWarnings("unused")
                public boolean contains(int k) {
                    return IntAbstractMap.this.containsKey(k);
                }
            };
        }
        return keySet;
        ...
        if (values == null) {
            values = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return IntAbstractMap.this.containsValue(v);
                }
            };
        }
        return values;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntAbstractMap)) {
            return false;
        }
        IntAbstractMap<V> t = (IntAbstractMap<V>) o;
        if (t.size() != size()) {
            return false;
        }
    ...
    protected Object clone() throws CloneNotSupportedException {
        IntAbstractMap<V> result = (IntAbstractMap<V>) super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
    ...
    static class SimpleEntry<VL> implements Entry<VL> {
        ...
        public SimpleEntry(int key, VL value) {
            this.key = key;
            this.value = value;
        }
    ...
    private class KeyIterator implements IntIterator {
        ...
        Iterator<IntMap.Entry<V>> entryIter;
