...
public class IntTreeMap<V> extends IntAbstractMap<V> implements Cloneable, SortedIntMap<V>, java.io.Serializable {
...
//   int cmp = key - t.key;
    ...
    private class SubMap extends IntAbstractMap<V> implements IntMap<V>, SortedIntMap<V>, java.io.Serializable {
    ...
    private class SubMapEntryIterator extends PrivateEntryIterator<IntMap.Entry<V>> {
