...
public class IntHashMapNC<V> extends IntAbstractMap<V> implements IntMap<V>, Cloneable, Serializable {
     ...
     */
    public IntHashMapNC(int initialCapacity, float loadFactor) {
     ...
     */
    public IntHashMapNC(int initialCapacity) {
     ...
     */
    public IntHashMapNC(IntMap<? extends V> m) {
   ...
   */
    ...
    @SuppressWarnings("unchecked")
    public Object clone() {
        IntHashMapNC<V> result = null;
        try {
            result = (IntHashMapNC<V>) super.clone();
    ...
    static class Entry<T> implements IntMap.Entry<T> {
         ...
         */
        void recordAccess(@SuppressWarnings("unused") IntHashMapNC<T> m) {
        }

        /**
         * This method is invoked whenever the entry is removed from the table.
         */
        void recordRemoval(@SuppressWarnings("unused") IntHashMapNC<T> m) {
        }
    }
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            int k = current.key;
            current = null;
            IntHashMapNC.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    ...
    private class KeySet extends AbstractSet<Integer> {
        ...
        public boolean remove(int o) {
            return IntHashMapNC.this.removeEntryForKey(o) != null;
        }

        public void clear() {
            IntHashMapNC.this.clear();
        }
    }
