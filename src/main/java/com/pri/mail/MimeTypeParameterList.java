...
/**
 * A parameter list of a MimeType as defined in RFC 2045 and 2046. The Primary type of the object must already be
 * stripped off.
 *
...
public class MimeTypeParameterList {
    ...
    protected void parse(String parameterList) throws MimeTypeParseException {
        ...
        int i;
        char c;
        for (i = skipWhiteSpace(parameterList, 0); i < length && (c = parameterList.charAt(i)) == ';';
