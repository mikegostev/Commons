 ...
 */
public class MimeTypeOrig implements Externalizable {
     ...
     */
    public MimeTypeOrig(String rawdata) throws MimeTypeParseException {
        parse(rawdata);
    }
     ...
     */
    public MimeTypeOrig(String primary, String sub) throws MimeTypeParseException {
